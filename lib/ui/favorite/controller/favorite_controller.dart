...
class FavoriteController extends BaseController {
  ...
  Future<void> getFavoriteItinerary({bool showLoading = true}) async {
    isLoading.value = true;
    subscribe(
      future: itineraryRepository.getFavoriteItinerary(),
  ...
  Future<void> refreshItineraryList() async {
    ...
    await getFavoriteItinerary(showLoading: false);
  }
