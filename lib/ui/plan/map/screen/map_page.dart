...
class MapPage extends BasePage<MapController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        if (controller.activities.isEmpty && !controller.showRoute.value) {
          return const Center(
        ...
        return Stack(
          children: [
            ...
            // Only show these widgets if not showing route
            if (!controller.showRoute.value) ...[
              Positioned(
                right: 20.w,
                bottom: 240.h,
                        ...
                        child: CarouselSlider.builder(
                          ...
                          itemBuilder: (context, index, realIdx) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                controller.zoomToActivity(index);
                              },
